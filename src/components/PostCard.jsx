...
function PostCard({ $id, title, featuredImage }) {
    return (
        <Link to={`/post/${$id}`}>
            <div className='post-card w-full h-80 overflow-hidden bg-red sm:hover:scale-105 transition-all duration-300 sm:rounded-2xl md:rounded-2xl lg:rounded-2xl'>
